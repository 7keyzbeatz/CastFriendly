    ...
    <form id="brandForm" method="POST" enctype="multipart/form-data">
        ...
        <section class="form-card">
            ...
            <div class="form-grid">
                ...
                <div class="field">
                    <label>Brand ID * (Για παράδειγμα: A, B, 1, 2, 3...)*</label>
                    <input 
                        type="text" 
                        name="id" 
                        required 
                ...
                <div class="field field-full">
                    ...
                    <input name="licenses" required 
                        value="<?= htmlspecialchars(
                            implode(
                                ', ',
                                is_array($brand['licenses'] ?? null)
                                ? $brand['licenses']
                                : []
                            )
                        ) ?>">
        ...
        <section class="form-card">
            ...
            <div class="form-grid">
                <div class="field field-full">
                    ...
                    <input name="referral" required 
                           value="<?= htmlspecialchars($brand['links']['claimOffer'] ?? '') ?>">
                </div>
            </div>
        </section>
